module.exports = {
  siteMetadata: {
    ...
    description: `4252 Concepts was founded with the intention to be creative, helpful, and inspiring. ` +
                  ...
                  `businesses with various digital services which include technology, development, photography, graphic arts, video creation, ` +
                  ...
                  `Ubiquiti, Unifi, Video Surveillance, Photography, Consulting, Management, Services, Solutions, ` +
                  `Small Business, SMB`,
    location: 'Locations: Washington, WA, Bellevue, Redmond, Kirkland, Cle Elum, Issaquah, Kent, Renton, Bothell, Woodinville, Seattle, Global, National, International',
